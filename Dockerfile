FROM --platform=$BUILDPLATFORM eclipse-temurin:24-jdk-noble AS builder
...
WORKDIR /app
COPY --from=builder --chown=appuser:appgroup /app/build/libs/hmpps-document-management-api*.jar /app/app.jar
