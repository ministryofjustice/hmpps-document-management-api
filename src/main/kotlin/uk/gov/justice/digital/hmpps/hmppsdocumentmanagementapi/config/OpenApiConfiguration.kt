  ...
  fun customOpenAPI(): OpenAPI? = OpenAPI()
    .info(
      Info()
        ...
        .version(version)
        .description("API for managing electronic documents. This service uses ClamAV to run a virus scan for any documents uploaded. ClamAV is updated twice daily at 6am and 6pm to" +
